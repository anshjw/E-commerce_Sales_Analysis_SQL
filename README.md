...
**🖥️ Query**: [1_create_view.sql](1_create_view.sql)
...
**🖥️ Query**: [3_cohort_analysis.sql](3_cohort_analysis.sql)
...
🖥️ Query: [4_retention_analysis.sql](4_retention_analysis.sql)
...
<img src="../0_Resources/Images/7.3_customer_churn_cohort_year.png" alt="Customer Churn by Cohort Year" style="width: 50%; height: auto;">
...
## Technical Details
- **Database:** PostgreSQL
- **Analysis Tools:** PgAdmin,Goggle Colab, Dbeaver
